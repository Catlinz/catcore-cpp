#ifndef CX_DEVICE_INPUT_CXINPUTQUEUE_H
#define CX_DEVICE_INPUT_CXINPUTQUEUE_H
...
#include "device/input/CxInputEvent.h"

namespace cat {

	/**
	 * @class CxInputQueue CxInputQueue.h "device/input/CxInputQueue.h"
	 * 
...
#endif // CX_DEVICE_INPUT_CXINPUTQUEUE_H
