#ifndef CX_CORE_COMMON_GNUC_CXGNUCATOMIC_H
#define CX_CORE_COMMON_GNUC_CXGNUCATOMIC_H
	...
	namespace atomic {
	   /**
		...
		CX_FORCE_INLINE CxI32 add32(CxI32 &inout_addend, CxI32 in_value) {
			return __sync_add_and_fetch(&inout_addend, in_value);
		}
		...
		CX_FORCE_INLINE CxI32 and32(CxI32 &inout_dest, CxI32 in_mask) {
			return __sync_and_and_fetch(&inout_dest, in_mask);
		}
		...
		CX_FORCE_INLINE CxBool compareAndSet32(CxI32 &inout_val, CxI32 in_old, CxI32 in_new) {
		   return __sync_bool_compare_and_swap(&inout_val, in_old, in_new);
		}
		...
		CX_FORCE_INLINE CxI32 or32(CxI32 &inout_dest, CxI32 in_mask) {
			return __sync_or_and_fetch(&inout_dest, in_mask);
		}
		...
		CX_FORCE_INLINE CxI32 xor32(CxI32 &inout_dest, CxI32 in_mask) {
		   return __sync_xor_and_fetch(&inout_dest, in_mask);
		}
	} // namespace atomic
} // namespace cat

#endif // CX_CORE_COMMON_GNUC_CXGNUCATOMIC_H
