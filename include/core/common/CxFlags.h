...
namespace cat {
	...
	class CxFlags {
	  public:
		...
		CX_FORCE_INLINE CxFlags(E in_val) : m_bits(in_val) {}
		...
		/** @brief Enum value assignment operator */
		CX_FORCE_INLINE CxFlags<E,T> & operator=(E in_val) { m_bits = in_val;  return *this; }
		/** @brief Bit storage assignment operator */
		CX_FORCE_INLINE CxFlags<E,T> & operator=(T in_val) { m_bits = in_val;  return *this;}
		/** @brief CxFlags assignment operator */
		CX_FORCE_INLINE CxFlags<E,T> & operator=(const CxFlags<E,T> &in_src) {
			m_bits = in_src.m_bits;  return *this;
		}

		/** @brief Type conversion operators */
		...
		/** @brief Return the raw bits of the enum */
		CX_FORCE_INLINE T bits() const { return m_bits; }
	  ...
	  /** @return True if all of the flags in in_val are set */
