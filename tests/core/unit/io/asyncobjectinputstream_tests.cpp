...
namespace cc {
	...
	void testAsyncObjectInputStreamBasicCreateAndDestroy() {
		BEGIN_TEST;
		...
		AsyncObjectInputStream* as = new AsyncObjectInputStream(s);
		assert( !as->canRead() );
		...
		as = new AsyncObjectInputStream(s);
		assert( as->canRead() );
		assert( as->getInputStream() );
	...
	void testAsyncObjectInputStreamClose() {
		BEGIN_TEST;
	...
	void testAsyncObjectInputStreamBasicReadFunctions() {
		BEGIN_TEST;
	...
	void testAsyncObjectInputStreamDataTypeSpecificReadFunctions() {
		BEGIN_TEST;
	...
	void testAsyncObjectInputStreamObjectReadFunction() {
		BEGIN_TEST;
...
int main(int argc, char** argv) {
	cc::testAsyncObjectInputStreamBasicCreateAndDestroy();
	cc::testAsyncObjectInputStreamClose();
	cc::testAsyncObjectInputStreamBasicReadFunctions();
	cc::testAsyncObjectInputStreamDataTypeSpecificReadFunctions();
	cc::testAsyncObjectInputStreamObjectReadFunction();
	return 0;
}
